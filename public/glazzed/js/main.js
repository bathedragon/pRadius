...
$(document).ready(function(){
    ...
    // Docs ul
    $('.file-structure>.sub>i').click(function(){
    ...
    // Attachment label stuff
    $('#file-att').on('change', function () {
        var files = this.files;
        $('#file-att ~ .label').html(files[0].name);
    });


    // Tab-radio stuff
    $('input[name^="tab-radio"]:checked').each(function(){
        var rId = $(this).val();
        $('#'+rId).fadeIn();
    })
    ...
    $('input[name^=tab-radio]').change(function(){
        ...
        var rId = $(this).val();
        $('.tab-radio-content[data-tab-radio="' + gName + '"]').hide();
        $('#'+rId).fadeIn();
    })


    // Demo 'Messages' tabs stuff
    $('.tabs>input').click(function(){
        actualTab();
    });
    $('.msg-o').change(function(){
        setTimeout(function(){actualTab()}, 100); // to review
    })
    $('.set_fav').click(function(){
        $(this).closest('.message').toggleClass('fav');
    })
    $('.close_cntrl').click(function(){
        var checkbox = $(this).closest('.message').find('.msg-o'),
    ...
    $('.c-btn--check').click(function(){
        $(this).closest('.message').toggleClass('checked');
    })
